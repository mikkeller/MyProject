...
var memberLiElement = function() {
    ...
    var newMembers = members.filter(function(v, i) { // filter s함수에 대해 공부하기!
        console.log(v, i);
        //return true;
    ...
    return {
        ...
        members: newMembers.map(function (v) { // 앞에서 내가 만들었던 map함수와 동일하다. map()은 원래 있던 함수다.
            //console.log(v);
...
setInterval(function() {
    var membersElement = memberLiElement();
    document.body.innerHTML = '<div>접속 멤버' + membersElement.totalCount + '명<ul>' + membersElement.members + '</ul></div>';
}, 1000);
