...
JavaScript는 각각의 언어에서 장점들을 가져와 개발된 언어야, 물론 단점도 있지만 그 단점을 충분히 보완할 수 있는 기능들이 참 많아. 자바에서는 문법과 '원시 값 vs 객체 관계'를, 스키마와 오크(AWK)에서는 일급 객체인 함수를, 셀프에서는 프로토타입 상속을, 펄과 파이썬에서는 문자열과 배열, 정규식을 빌려왔지.
